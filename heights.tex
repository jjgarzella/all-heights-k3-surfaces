...
library \texttt{ToricControlledReduction} 
...
Our method is comparable to \texttt{ToricControlledReduction} to find
the height for \(p = 11\). On an Nvidia 3090 our method took 
around 39-40 seconds per surface, while \texttt{ToricControlledReduction} took 
about 43 seconds per surface.
For \(p = 13\), our 
code took 100-110 seconds per surface, while \texttt{ToricControlledReduction}
