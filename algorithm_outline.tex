...
.\] 
The fact that the polynomials \(S_{n}\) and \(Ps_{n}\) do not depend on the base
...
\begin{ex}
    ...
    Then, we multiply by \(\Delta_{1}(g)\) getting a polynomial of degree 24.
    ...
    since this choice of f, all of the exponents for all quantities 
