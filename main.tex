...
\begin{abstract}
    We develop a fast algorithm to calculate the Artin-Mazur height (equivalently, the
    quasi-\(F\)-split height) of a Calabi-Yau hypersurface, building on the work in
    \cite{kty-2022-fedder}. 
    We provide a implementation of our approach, and use it to show that there are quartic
