...
Raising 4-variate, 16-homogeneous polynomial to the 5:
  0.002026 seconds (769 CPU allocations: 20.234 KiB) (9 GPU allocations: 18.109 MiB, 1.95% memmgmt time)
        Raising 4-variate, 16-homogeneous polynomial to the 6:
  0.004124 seconds (968 CPU allocations: 2.416 MiB) (10 GPU allocations: 31.183 MiB, 1.53% memmgmt time)
        Raising 4-variate, 16-homogeneous polynomial to the 7:
  0.007675 seconds (968 CPU allocations: 3.789 MiB) (10 GPU allocations: 59.310 MiB, 1.01% memmgmt time)
        Raising 4-variate, 16-homogeneous polynomial to the 8:
  0.013911 seconds (969 CPU allocations: 5.607 MiB) (10 GPU allocations: 112.781 MiB, 0.48% memmgmt time)
        Raising 4-variate, 16-homogeneous polynomial to the 9:
  0.015010 seconds (969 CPU allocations: 7.933 MiB) (10 GPU allocations: 119.759 MiB, 0.48% memmgmt time)
        Raising 4-variate, 16-homogeneous polynomial to the 10:
  0.014185 seconds (969 CPU allocations: 10.829 MiB) (10 GPU allocations: 128.446 MiB, 0.49% memmgmt time)
        Raising 4-variate, 16-homogeneous polynomial to the 11:
  0.065306 seconds (1.12 k CPU allocations: 28.695 MiB, 33.25% gc time) (10 GPU allocations: 320.563 MiB, 0.70% memmgmt time)
        Raising 4-variate, 16-homogeneous polynomial to the 12:
  0.044647 seconds (1.12 k CPU allocations: 37.141 MiB) (10 GPU allocations: 339.568 MiB, 0.17% memmgmt time)
        Raising 4-variate, 16-homogeneous polynomial to the 13:
  0.096405 seconds (1.13 k CPU allocations: 47.103 MiB, 21.23% gc time) (10 GPU allocations: 618.044 MiB, 0.93% memmgmt time)
        Raising 4-variate, 16-homogeneous polynomial to the 14:
  0.102248 seconds (1.13 k CPU allocations: 58.704 MiB, 18.92% gc time) (10 GPU allocations: 644.147 MiB, 1.00% memmgmt time)
        Raising 4-variate, 16-homogeneous polynomial to the 15:
  0.109892 seconds (1.13 k CPU allocations: 72.070 MiB, 17.81% gc time) (10 GPU allocations: 674.220 MiB, 0.92% memmgmt time)
