...
is exact even in floating point types. 
...
\(o = 4194303, \,1048575, \,466032, \,167771, \,116507\).
...
than OpenBLAS when using CPU multithreading, it gives exact
...
Note that our CPU BLAS tests are called via the default matrix multiplication from Julia and FLINT
...
\begin{tabular}{c c c c c}
    ...
    \bottomrule
\end{tabular}
\caption{Dense square matrix-matrix multiplication times (in seconds) in characteristic $11$}
\end{center}
\end{figure}
