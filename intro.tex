...
our algorithms for calculating the matrix
% We say "multiply then split" everywhere else
of the key linear operator which we term ``multiply then split''.
In Section 4, we describe our GPU-based implementation polynomial
powering via an incremental FFT-based multiplication algorithm which uses 
